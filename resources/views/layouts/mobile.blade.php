    ...
    <div class="mobile-wrapper">
                    ...
                    <div class="dropdown-menu" id="userDropdownMenu">
                        ...
                        <a href="#" class="sub-text" data-toggle="modal" data-target="#editProfileModal">
                            <img src="{{ asset('assets/icons/configuracion.png') }}" alt="Configuración"
                                class="sub-icon">Configuración de Cuenta
                        </a>
        ...
        <footer class="mobile-footer">
            <div class="footer-menu">
                <a href="{{ url('/seguimiento-actividades') }}"
                    class="footer-icon {{ request()->is('seguimiento-actividades') ? 'active' : '' }}">
                ...
                <a href="#" class="footer-icon {{ request()->is('inventario-turno') ? 'active' : '' }}"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="25.408" height="25.368" viewBox="0 0 25.408 25.368">
                        <g id="Grupo_23275" data-name="Grupo 23275" transform="translate(16.683 -330.966)">
                            <path id="Trazado_17466" data-name="Trazado 17466"
                                d="M-15.345,343.956c0,1.949.006,3.9-.006,5.846a.476.476,0,0,0,.332.512q5.087,2.249,10.165,4.519a.635.635,0,0,0,.583-.067.678.678,0,0,1,.813.158.651.651,0,0,1,.051.775,1.6,1.6,0,0,1-1.63.511q-5.557-2.47-11.114-4.937a.825.825,0,0,1-.53-.839q0-6.8,0-13.591a.822.822,0,0,1,.534-.835q3.948-1.743,7.889-3.5c1.084-.482,2.171-.959,3.252-1.446a.947.947,0,0,1,.826.005q5.528,2.462,11.062,4.91a.855.855,0,0,1,.573.892c-.015,2-.007,4-.006,5.994a.794.794,0,0,1-.125.537.665.665,0,0,1-1.162-.2,1.343,1.343,0,0,1-.049-.47q0-2.315,0-4.629c0-.383,0-.383-.335-.234q-4.934,2.191-9.866,4.388a1.154,1.154,0,0,1-1.02,0q-4.115-1.842-8.238-3.667c-.569-.253-1.141-.5-1.7-.765-.244-.115-.3-.056-.3.2C-15.342,340-15.345,341.978-15.345,343.956ZM5.086,336.7a.725.725,0,0,0-.118-.1q-2.031-.9-4.062-1.808a.41.41,0,0,0-.366.029l-7.991,3.552c-.484.215-.966.435-1.442.649.019.105.081.119.134.142,1.318.586,2.638,1.169,3.954,1.759a.5.5,0,0,0,.45-.02q4.184-1.863,8.371-3.719C4.363,337.026,4.709,336.867,5.086,336.7Zm-6.045-2.678c-.069-.118-.175-.132-.26-.17-1-.448-2.009-.882-3-1.344a.848.848,0,0,0-.779.009q-4.506,2.017-9.02,4.016c-.077.034-.2.041-.205.142s.124.112.2.146c1.028.46,2.061.911,3.086,1.38a.674.674,0,0,0,.614-.007q3.613-1.618,7.233-3.218C-2.384,334.657-1.675,334.338-.959,334.018Z"
                                transform="translate(0 0)" />
                            <path id="Trazado_17467" data-name="Trazado 17467"
                                d="M197.1,550.213a6.359,6.359,0,1,1,6.365,6.374A6.354,6.354,0,0,1,197.1,550.213Zm1.337,0a5.019,5.019,0,1,0,5.079-5.012A5.013,5.013,0,0,0,198.438,550.212Z"
                                transform="translate(-201.093 -200.253)" />
                            <path id="Trazado_17468" data-name="Trazado 17468"
                                d="M261.519,619.483a.665.665,0,0,1-.225.5c-1.028,1.028-2.053,2.059-3.086,3.082a.659.659,0,0,1-1.021-.007q-.752-.737-1.49-1.49a.667.667,0,1,1,.932-.945c.293.28.584.563.858.861.159.173.261.17.426,0,.8-.812,1.6-1.614,2.41-2.415a.682.682,0,0,1,1.021-.048A.639.639,0,0,1,261.519,619.483Z"
                                transform="translate(-255.975 -270.763)" />
                        </g>
                    </svg>
                    <span>Inventario</span>
                </a>
                <a href="#" class="footer-icon {{ request()->is('informacion-novedades') ? 'active' : '' }}"
                    onclick="location.href = '{{ route('informacion.novedades.index') }}';">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24.295" height="24.301"
                        viewBox="0 0 24.295 24.301">
                        <g id="Grupo_23266" data-name="Grupo 23266" transform="translate(1367.378 -425.607)">
                            <path id="Trazado_17452" data-name="Trazado 17452"
                                d="M-1355.157,425.607a12.14,12.14,0,0,0-12.221,12.046,12.142,12.142,0,0,0,12.012,12.255,12.138,12.138,0,0,0,12.282-12.108A12.14,12.14,0,0,0-1355.157,425.607Zm-.156,22.782a10.662,10.662,0,0,1-10.546-10.715,10.663,10.663,0,0,1,10.712-10.549A10.664,10.664,0,0,1-1344.6,437.84,10.664,10.664,0,0,1-1355.313,448.389Z" />
                            <path id="Trazado_17453" data-name="Trazado 17453"
                                d="M-1320.4,468.026c0,1.358-.009,2.717,0,4.075.006.658-.207,1.194-.915,1.221-.788.03-1.022-.526-1.02-1.239q.012-4.075,0-8.15c0-.657.2-1.193.916-1.22.789-.03,1.025.524,1.019,1.237C-1320.411,465.31-1320.4,466.668-1320.4,468.026Z"
                                transform="translate(-33.863 -27.897)" />
                            <path id="Trazado_17454" data-name="Trazado 17454"
                                d="M-1320.705,446.674c-.152.737-.534,1.184-1.276,1.115a1.042,1.042,0,0,1-1.018-1.17,1.064,1.064,0,0,1,1.242-1.073C-1321.07,445.6-1320.8,446.094-1320.705,446.674Z"
                                transform="translate(-33.361 -14.987)" />
                        </g>
                    </svg>
                            ...
                            <form method="POST" action="{{ route('profile.update') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nombres"
                                        ...
                                        value="{{ old('nombres', Auth::user()->nombres) }}" required>
                                    @error('nombres')
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', function(e) {
                if (!userDropdownMenu.is(e.target) && userDropdownMenu.has(e.target).length === 0 && !$(
                        '#userDropdownToggle').is(e.target)) {
